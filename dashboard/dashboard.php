...
if ($resultp->num_rows > 0) {
    ...
    $totalPatients = $rowp["total_patients"];
}
...
if ($resultd->num_rows > 0) {
    ...
    $totalDoctors = $rowd["total_doctors"];
}

// Query to get the total number of nurses
$sql = "SELECT COUNT(*) AS total_nurses FROM nurse";
...
if ($resultn->num_rows > 0) {
    ...
    $totalNurses = $rown["total_nurses"];
}

// Query to get the total number of receptions
$sql = "SELECT COUNT(*) AS total_receptions FROM reception";
...
if ($resultr->num_rows > 0) {
    ...
    // Get the total number of receptions
    $totalReceptions = $rowr["total_receptions"];
}
...
<section class="home_section">
    ...
    <div class="card-boxes">
        <div class="box">
            <div class="right_side">
                <div class="numbers"><?php echo $totalPatients; ?></div>
                <div class="box_topic">Total Patients</div>
            </div>
            <i class='bx bx-user'></i>
        </div>
        <div class="box">
            <div class="right_side">
                <div class="numbers"><?php echo $totalDoctors; ?></div>
                <div class="box_topic">Total Doctors</div>
            </div>
            <i class='bx bx-user'></i>
        </div>
        <div class="box">
            <div class="right_side">
                <div class="numbers"><?php echo $totalNurses; ?></div>
                <div class="box_topic">Total Nurses</div>
            </div>
            <i class='bx bx-user'></i>
        </div>
        <div class="box">
            <div class="right_side">
                <div class="numbers"><?php echo $totalReceptions; ?></div>
                <div class="box_topic">Total Receptions</div>
            </div>
            <i class='bx bx-user'></i>
        </div>
    </div>
    ...
    <?php } ?>
                    ...
                    echo "<tr><td colspan='7'><p style='text-align:center;'>No patient found</p></td></tr>";
        ...
        <div class="card_header">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    if (strlen($phone) != 10 || !ctype_digit($phone)) {
                                        ...
                                        if ($stmt) {
                                            ...
                                            // Execute statement
                                            if ($stmt->execute()) {
                                                echo "<script>window.location.pathname = 'Web/dashboard/dashboard.php';</script>";
                                                exit;
                                            } else {
            ...
            if (isset($_POST["update_patient"])) {
               ...
               if(isset($_POST["password"])) {
                   ...
                   $sql = "UPDATE patients SET name='$name', email='$email', phone_number='$phone_number', address='$address', dateofbirth='$dateofbirth', password='$password' WHERE id='$id'";
               } else {
                   // Update query without password
                   $sql = "UPDATE patients SET name='$name', email='$email', phone_number='$phone_number', address='$address', dateofbirth='$dateofbirth' WHERE id='$id'";
               }
